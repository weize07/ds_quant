...
<div class="grid">
  ...
  <div class="card wide"><h3>郑糖量仓结构（价格 + 成交量 + 持仓量）<span id="quadTag" style="font-size:12px;color:#6b7280;margin-left:8px"></span></h3><div id="c9" class="chart"></div></div>
  ...
  <div class="card"><h3>厄尔尼诺/拉尼娜指数 ONI（2005至今）<span id="oniNote" style="font-size:12px;color:#6b7280;font-weight:normal;margin-left:8px"></span></h3><div id="c4" class="chart"></div></div>
  <div class="card"><h3>ONI 领先郑糖的滞后相关（核心分析）</h3><div id="c5" class="chart"></div></div>

  <div class="card"><h3>统计因子：郑糖 z-score（价 vs 250日均值的标准差）</h3><div id="c11" class="chart"></div></div>
  <div class="card"><h3>统计因子：20日年化波动率 + 多周期分位</h3><div id="c12" style="padding-top:8px"></div></div>

  <div class="card"><h3>郑糖 vs 中粮糖业股价（月度散点 + 回归线）</h3><div id="c6" class="chart"></div></div>
  <div class="card"><h3>相关性结论</h3><div id="c7" style="padding-top:10px"></div></div>

  <div class="card wide"><h3>郑糖与股价的相关性随时间变化（12个月滚动相关系数）</h3><div id="c8" class="chart"></div></div>

  <div class="card wide"><h3>反转概率历史轨迹 + 各维度得分演变</h3><div id="c10" class="chart"></div></div>

  <div class="card wide"><h3>进口利润率 + z-score 历史（"外强内弱"压缩可视化）</h3><div id="c13" class="chart"></div></div>
